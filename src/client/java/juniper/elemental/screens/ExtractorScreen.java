...
public class ExtractorScreen extends HandledScreen<ExtractorScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        DrawingUtil.drawGuiPartial(context, EXTRACT_PROGRESS_TEXTURE, Direction.LEFT, 22, 16, 0, 0, 22, 16, this.x + 96, this.y + 35, progress, ExtractorBlockEntity.MAX_PROGRESS);
    }
