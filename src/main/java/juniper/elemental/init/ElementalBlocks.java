...
public class ElementalBlocks {
    ...
    public static Block DARK_BLOCK = register("dark_block", Block::new, AbstractBlock.Settings.create().strength(1.5f).requiresTool(), true);
    ...
    public static Block ALKAHEST = register("alkahest", AlkahestBlock::new, AbstractBlock.Settings.create().replaceable().noCollision().dropsNothing().strength(-1).liquid(), false);
